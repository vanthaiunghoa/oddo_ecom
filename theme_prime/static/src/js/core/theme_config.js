...
var ThemeOptionBottomBar = AbstractThemeOption.extend({
    ...
    _fetchData: async function () {
        this.actions = await this._rpc({ model: 'website', method: 'get_theme_prime_bottom_bar_action_buttons'});
    },
    _render: function () {
        this._super.apply(this, arguments);
...
var ThemeConfigDialog = Dialog.extend({
    template: 'theme_prime.theme_configurator_dialog',
    xmlDependencies: Dialog.prototype.xmlDependencies.concat(['/theme_prime/static/src/xml/core/theme_config.xml']),
...
var ThemePrimeConfig = WebsiteNavbarActionWidget.extend({
...
registry.category('website_navbar_widgets').add('ThemePrimeConfigMenu', {
    Widget: ThemePrimeConfig,
    selector: '#tp_prime_config',
});

export default {
    AbstractThemeOption, ThemeOptionTitle, ThemeOptionRadio, ThemeOptionCheckbox, ThemeOptionSelection, ThemeOptionNumber,
    ThemeOptionJson, ThemeOptionBottomBar, ThemeConfigDialog, ThemePrimeConfig
};

/** @odoo-module alias=theme_prime.domain_builder */
...
var DomainBuilder = AbstractComponent.extend({
    ...
    xmlDependencies: ["/theme_prime/static/src/xml/editor/components/domain_component.xml"],
    events: {
    ...
    onClickViewProducts: function () {
        ...
        return this._rpc({
            route: '/theme_prime/tp_search_read',
            ...
            d._opened.then(function () {
                d.$modal.toggleClass('o_technical_modal droggol_technical_modal');
            });
        });
    },
...
registry.category("theme_prime_components").add("DomainBuilderComponent", DomainBuilder);

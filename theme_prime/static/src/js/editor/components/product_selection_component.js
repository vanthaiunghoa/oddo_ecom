...
let ProductsSelectionComponent = AbstractComponent.extend({
    ...
    _getCategoryConfig: function () {
        return {
            ...
            dropdownTemplate: 'theme_prime.category_selection_dropdown_item',
            listTemplate: 'theme_prime.selected_category_item'
        };
    },
    /**
     * @private
    ...
    _getProductTemplateConfig: function () {
        return {
            ...
            dropdownTemplate: 'theme_prime.product_selection_dropdown_item',
            listTemplate: 'theme_prime.selected_product_item'
        };
    },
    /**
     * @private

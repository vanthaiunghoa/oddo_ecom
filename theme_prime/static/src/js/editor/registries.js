...
registry.category('theme_prime_snippet_registry')
    .add('d_products_snippet', { widgets: { SelectionComponent: { model: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_card_registry', subComponents: ['style', 'mode', 'ppr'] } } })
    .add('s_two_column_card', { widgets: { SelectionComponent: { model: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_two_column_card_registry', subComponents: ['style', 'mode'] } } })
    ...
    .add('d_category_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_card_registry', subComponents: ['style', 'mode', 'ppr', 'tabStyle', 'sortBy', 'limit', 'includesChild'] } } })
    .add('d_single_category_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_small_card_registry', subComponents: ['style', 'sortBy', 'includesChild'] } }, defaultValue: { recordsLimit: 1, noSwicher: true } })
    ...
    .add('d_top_categories', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_top_category_card_registry', subComponents: ['style', 'sortBy', 'includesChild'] } }, defaultValue: { recordsLimit: 3, noSwicher: true } })
    .add('s_category_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_category_card_registry', subComponents: ['style'] } }, defaultValue: { noSwicher: true } })
    .add('s_product_listing_cards', { widgets: { UiComponent: { noSelection: true, cardRegistry: 'theme_prime_product_list_cards', headerRegistry: 'theme_prime_product_list_cards_headers', subComponents: ['style', 'header', 'bestseller', 'newArrived', 'discount'] } }})
    .add('s_tp_mega_menu_category_snippet', { widgets: { SelectionComponent: { model: 'product.public.category', subModel: 'product.template' }, UiComponent: { SelectionComponentName: 'ProductsSelectionComponent', cardRegistry: 'theme_prime_mega_menu_cards', maxValue: 5, minValue:2, subComponents: ['style', 'limit'] } }, defaultValue: { noSwicher: true } });

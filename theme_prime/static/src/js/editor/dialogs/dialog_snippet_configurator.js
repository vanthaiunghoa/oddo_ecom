/** @odoo-module alias=theme_prime.dialog_snippet_configurator */
...
let ConfigDialog =  Dialog.extend({
    ...
    xmlDependencies: Dialog.prototype.xmlDependencies.concat(['/theme_prime/static/src/xml/editor/dialogs/snippet_configurator_dialog.xml']),
    ...
    _appendWidgets: function () {
        let BodyComponent = registry.category("theme_prime_components").get('BodyComponent');

...
const {HotspotMixns} = require('theme_prime.mixins');
const options = require('web_editor.snippets.options');
const website_options = require('website.editor.snippets.options');
const SnippetConfigurator = require('theme_prime.dialog_snippet_configurator');
...
options.registry.s_tp_documents_snippet = options.Class.extend({
    ...
    xmlDependencies: ['/theme_prime/static/src/xml/frontend/documents.xml'],
    /**
    * @override
    */
    start: function () {

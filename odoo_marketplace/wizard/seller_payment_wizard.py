    ...
    def do_request(self):
        ...
        if not msg and self.validate_payment_request():
            ...
            seller_payment_menu_id = self.env[
                'ir.model.data'].check_object_reference('odoo_marketplace', 'wk_seller_payment_method')[1]
            seller_payment_action_id = self.env[
                'ir.model.data'].check_object_reference('odoo_marketplace', 'wk_seller_payment_action')[1]
            return {
